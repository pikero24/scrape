...
class LivingSocialSpider(BaseSpider):
    """Spider for regularly updated livingsocial.com site, DC Page"""
    name = "livingsocial"
    allowed_domains = ["livingsocial.com"]
    start_urls = ["http://www.livingsocial.com/cities/1-washington-d-c"]
    ...
    def parse(self, response):
        ...
        Testing contracts:
        @url http://www.livingsocial.com/cities/1-washington-d-c"
        @returns items 1
        @scrapes title link
